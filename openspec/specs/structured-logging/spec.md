...
Define logging behavior across the application to ensure consistent, observable, and environment-appropriate log output. Structured logging enables efficient debugging in development and machine-readable output in production.
